...
<div class="widget-first widget recent-posts">
    <h3>{{ Lang::get('lv.latest_projects')}}</h3>
            ...
            @foreach($portfolios as $portfolio)
                ...
                <div class="hentry-post group">
                    ...
                    <div class="text">
                        ...
                        <a class="read-more" href="{{ route('portfolios.show', ['alias' => $portfolio->alias]) }}">&rarr; {{ Lang::get('lv.read_more') }}</a>
                    </div>
                </div>
    ...
    @if(!$comments->isEmpty())
        <div class="widget-last widget recent-comments">
            <h3>{{ Lang::get('lv.latest_comments') }}</h3>
            <div class="recent-post recent-comments group">
                ...
                @foreach($comments as $comment)
                    ...
                    <div class="the-post group">
                        ...
                        <span class="author"><strong><a href="#">{{ isset($comment->user) ? $comment->user->name : $comment->name }}</a></strong>{{ Lang::get('lv.comment_in') }}</span>
