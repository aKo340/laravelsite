<div id="content-single" class="content group">
    <div class="hentry hentry-post blog-big group ">
        ...
        <div class="meta group">
            ...
            <p class="comments"><span><a href="#comments" title="Comment on This is the title of the first article. Enjoy it.">{{ count($article->comments) ? count($article->comments) : '0' }} {{ Lang::choice('lv.comments', count($article->comments)) }}</a></span></p>
        </div>
        <!-- post content -->
    ...
    <div id="comments">
        <h3 id="comments-title">
            <span>{{ count($article->comments) }}</span> {{ Lang::choice('lv.comments',  count($article->comments)) }}
        </h3>
