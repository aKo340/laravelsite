...
<head>
    ...
    <title>{{ $title or 'My first Laravelsite' }}</title>

    <!-- [favicon] begin -->
    <link rel="shortcut icon" type="image/x-icon" href="{{ asset(env('THEME')) }}/images/favicon/favicon.ico" />
    <link rel="icon" type="image/x-icon" href="{{ asset(env('THEME')) }}/images/favicon/favicon.ico" />
    ...
    <div id="wrapper" class="group">
        ...
        <div id="header" class="group">
            ...
            <div class="group inner">
                ...
                <div id="logo" class="group">
                    <a href="index.html" title="My first Laravelsite"><img src="{{ asset(env('THEME')) }}/images/logo.png" title="My first Laravelsite" alt="My first Laravelsite" /></a>
                </div>
                <!-- END LOGO -->
        ...
        <div id="page-meta">
            <div class="inner group">
                <h3>{{ Lang::get('lv.welcom_to') }}</h3>
                <h4>{{ Lang::get('lv.i_hope') }}</h4>
            </div>
        </div>
        <!-- END PAGE META -->
