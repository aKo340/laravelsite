        ...
        fadeIn(500,function() {
            ...
            $.ajax({
                ...
                success: function(html) {
                    if(html.error) {
                        $('.wrap_result').css('color','red').append('<br /><strond>Kļūda: </strong>' + html.error.join('<br />'));
                        $('.wrap_result').delay(2000).fadeOut(500);
                    }
                    else if(html.success) {
                        $('.wrap_result')
                            .append('<br /><strong>Saglabāts!</strong>')
                            .delay(2000)
                ...
                error:function() {
                    $('.wrap_result').css('color','red').append('<br /><strond>Kļūda: </strong>');
